...
UNION ALL
SELECT 'organization_automation_settings' AS table_name, COUNT(*) AS rows, MAX(updated_at) AS max_updated_at
FROM organization_automation_settings WHERE org_id = '00000000-0000-0000-0000-000000000001'
UNION ALL
